...
<head>
    ...
    <!-- Cho phép IE8/9 hỗ trợ truy vấn media, từ đó tương thích với lưới -->
    <!--[if lt IE 9]>
...
<div class="layui-fluid">
    <form class="layui-form" action="<?=links('comic','lists_edit_save')?>">
        <div class="layui-form-item">
            <label class="layui-form-label">Thuộc danh mục lớn</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Bí danh tiếng Anh</label>
            <div class="layui-input-block">
                <input type="text" name="yname" autocomplete="off" class="layui-input" value="<?=$yname?>" placeholder="Vui lòng nhập tên danh mục tiếng Anh, chỉ được sử dụng chữ cái">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Số thứ tự sắp xếp</label>
            <div class="layui-input-block">
                <input type="number" name="xid" required lay-verify="required" autocomplete="off" class="layui-input" value="<?=$xid?>" placeholder="Vui lòng nhập số thứ tự sắp xếp, càng nhỏ càng lên đầu">
            </div>
        </div>
