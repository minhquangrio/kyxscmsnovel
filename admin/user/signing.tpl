...
<head>
<meta charset="UTF-8">
<title>Danh sách người dùng đã ký hợp đồng</title>
...
<div class="breadcrumb-nav">
    <span class="layui-breadcrumb">
        ...
        <a><cite>Danh sách người dùng đã ký hợp đồng</cite></a>
    </span>
            ...
            <div class="layui-form toolbar">
                <div class="layui-form-item" style="margin-top: 10px;">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="Admin.del('<?=links('user','signing_del')?>','user')"><i class="layui-icon"></i>Hủy hợp đồng</button>
                    </div>
                    ...
                    <div class="layui-inline select100 mr0">
                        <div class="layui-input-inline h30">
                            <select name="zd">
                                ...
                                <option value="tel">Số điện thoại liên lạc</option>
                                <option value="qq">Liên lạc QQ</option>
                                <option value="email">Email liên lạc</option>
                                <option value="city">Khu vực thành phố</option>
                    ...
                    <div class="layui-inline select100 mr0">
                        <div class="layui-input-inline h30">
                            <select name="cid">
                                ...
                                <option value="2">Đang chờ xem xét</option>
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('user','signing_ajax')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'user'}" lay-filter="user">
              <thead>
                ...
                <?php }else{ ?>
                    ...
                    <th lay-data="{field:'ticket',width:80,align:'center'}">Vé tháng</th>
                    <th lay-data="{field:'sid',width:80,align:'center',templet:'#ztTpl'}">Trạng thái</th>
...
<script type="text/html" id="cmdTpl">
    ...
    <button style="margin-left:5px;" title="Hủy hợp đồng" class="layui-btn-danger layui-btn layui-btn-xs" onclick="Admin.del('<?=links('user','signing_del')?>','{{d.id}}',this)" href="javascript:;" ><i class="layui-icon"></i></button>
</script>
<script>
function show_img(t) {
    var t = $(t).find("img");
